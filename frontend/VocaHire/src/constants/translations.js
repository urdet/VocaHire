export const translations = {
  en: {
    brand: "VocaHire",
    welcome_description: "Review your session or launch a new evaluation.",
  ...
  fr: {
    brand: "VocaHire",
    welcome_description: "Consultez votre session ou lancez une nouvelle évaluation.",
    welcome: "Bonjour,",
    name: "Alex",
  ...
  ar: {
    brand: "VocaHire",
    welcome_description: "راجع حصصك أو أطلق تقييماً جديداً.",
    welcome: "صباح الخير،",
    name: "أليكس",
